package com.qz.springSocialCore.openidLogin.filter;
...
public class OpenIdAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
    ...
    private static String socialLoginUrl="/authentication/openid";
    ...
    public OpenIdAuthenticationFilter(){
        //要拦截的请求
        super(new AntPathRequestMatcher(socialLoginUrl, "POST"));
    }
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException {
        if (this.postOnly && !request.getMethod().equals("POST")) {
            ...
            //把openId, providerId传入OpenIdAuthenticationToken
